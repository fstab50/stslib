...
[Credential Dual Format Overview](./docs/markdown/credential_format_overview.md).  
...
* **stsAval** supports 2 credential formats.  See the [Credential Dual Format Overview](./docs/markdown/credential_format_overview.md)
