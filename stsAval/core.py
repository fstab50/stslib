"""
Summary:
    stsAval generates temporary credentials used to assume roles across
...
Example Usage:
    see https://bitbucket.org/blakeca00/stsaval/overview
"""
...
class StsCore():
    ...
    def parse_profiles(self, pre_name, post_name):
        ...
        Args:
            ...
            :type string
            :param post_name: json file containing role profiles for which stsaval will
            generate temporary credentials. This file is generated by stsAval and
            will be located in the ~/.stsaval directory. Format:
