...
class StsCore():
    ...
    def parse_profiles(self, pre_name, post_name):
        ...
        :type string
        :param post_name: json file containing role profiles for which
                          stsaval will generate temporary credentials.  This
                          file is generated by stsAval and will be located in
                          the ~/.stsaval directory. Format:
