...
class StsCore():
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            :role_file (str): optional name of a json structured file located stsaval
                config directory in users home directory. File contains information
                about roles for which you which to generate temporary credentials
    ...
    def parse_profiles(self, pre_name=None, post_name=None):
        ...
        Args:
            :type string
            :param pre_name: input file containing iam role credentials in non-default
                location or fname

            :type string
            :param post_name: json file containing role profiles for which stsaval
